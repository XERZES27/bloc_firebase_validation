...
class flareBackground extends StatelessWidget {
  @override
          ...
          Container(
            ...
            decoration: BoxDecoration(
                gradient: LinearGradient(
                    stops: [0.15, 1],
                    colors: [Color(0xFFFFFFFF), Color(0xFF5E35B1)],
...
const List<Color> pinkGradinets=[
  Color(0xFFC51162),
  Color(0xFF880E4F),
  Color(0xFFF50057)
